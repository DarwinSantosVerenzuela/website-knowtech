...
export default function ServicePage() {
  return (
    <main className="asesoria-container">
      ...
      <h1 className="asesoria-title">ASESORIA</h1>
      <p className="asesoria-description">
        Bienvenido a la página de <strong>ASESORIA</strong>.
        <br /><br />
        Este es un archivo individual (page.tsx) con su propio CSS (asesoria.css).
        Aquí puedes editar el contenido específico para este servicio sin afectar a los demás.
      </p>

      <div className="mt-10 p-6">
        <p className="text-gray-400 text-sm">Archivo: app/servicios/asesoria/page.tsx</p>
      </div>
    </main>
  );
}
